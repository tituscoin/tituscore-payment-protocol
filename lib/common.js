...
PaymentProtocol.LEGACY_PAYMENT.BTC.REQUEST_CONTENT_TYPE = 'application/tituscoin-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.BTC.CONTENT_TYPE = 'application/tituscoin-payment';
PaymentProtocol.LEGACY_PAYMENT.BTC.ACK_CONTENT_TYPE = 'application/tituscoin-paymentack';

PaymentProtocol.LEGACY_PAYMENT.BCH.REQUEST_CONTENT_TYPE = 'application/tituscoincash-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.BCH.CONTENT_TYPE = 'application/tituscoincash-payment';
PaymentProtocol.LEGACY_PAYMENT.BCH.ACK_CONTENT_TYPE = 'application/tituscoincash-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Titus Coin Signed Message:\n');
